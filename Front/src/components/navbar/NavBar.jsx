      ...
      {isNonMobileScreens ? (
       <Box
        ...
        <RouterLink
         ...
         <Typography sx={{ color: font, fontSize:"20px", fontWeight:"1000", letterSpacing: '2px',  }}>REGISTRARME</Typography>
        </RouterLink>

        <RouterLink
         to='/login'
         style={{ textDecoration: 'none' }}>
         <Typography  sx={{ color: font, fontSize:"20px", fontWeight:"1000", letterSpacing: '2px',paddingRight:'10px'  }}>INICIO SESION</Typography>
        </RouterLink>
        <UserIconNoLogged
         onLoginClick={handleLoginClick}
         onRegisterClick={handleRegisterClick}   
